...
namespace WPFChart3D
{
    public class TransformMatrix
    {
        ...
        public static Point3D Transform(Point3D pt1, Point3D center, double aX, double aZ)
        {
            ...
            double x3 =  x2 * Math.Cos(angleX) - y2 * Math.Sin(angleX);
            double y3 =  x2 * Math.Sin(angleX) + y2 * Math.Cos(angleX);
			double z3 =  z2;
        ...
        public static void Transform(Mesh3D model, Point3D center, int type)
        {
            ...
            {
                case 1:
                    setAxisMatrix = new double[9] { cosAlpha, 0, sinAlpha, 0, 1, 0, -sinAlpha, 0, cosAlpha };
                    break;
                case 2:
                    setAxisMatrix = new double[9] { 1, 0, 0, 0, cosAlpha, -sinAlpha, 0, sinAlpha, cosAlpha };
                    break;
                case 3:
                    setAxisMatrix = new double[9] { cosAlpha, -sinAlpha, 0, sinAlpha, cosAlpha, 0, 0, 0, 1 };
                    break;
